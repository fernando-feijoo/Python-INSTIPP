...
urlpatterns = [
    ...
    path('medidas/', UMView.as_view(), name='um_list'),
    path('medidas/new', UMNew.as_view(), name='um_new'),
    path('medidas/edit/<int:pk>', UMEdit.as_view(), name='um_edit'),
    path('medidas/inactivar/<int:id>', um_inactivar, name='um_inactivar'),
]
